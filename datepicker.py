...
class Calendar(ttk.Frame):
    ...
    def __init__(self, master=None, year=None, month=None, firstweekday=calendar.MONDAY, locale=None,
        ...
        self._selected_date = self.datetime.now()
...
class Datepicker(ttk.Entry):
    def __init__(self, master, entrywidth=None, entrystyle=None, datevar=None, dateformat="%Y-%m-%d", onselect=None,
                 ...
                 selectbackground='#003eff', selectforeground='white', state='normal',borderwidth=1, relief="solid"):
        ...
        ttk.Entry.__init__(self, master, textvariable=self.date_var, **entry_config,state=state)
    ...
    def set_date_from_calendar(self):
        ...
        if self.is_calendar_visible:
            ...
            self.hide_calendar()
        self.configure(state=originalstate)
    @property
...
#    initdate= StringVar()
#    initdate.set("20171231")
#    dp= Datepicker(main,dateformat="%Y%m%d",datevar=initdate,)
#    dp.pack(anchor="w")
